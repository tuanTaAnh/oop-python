...
if __name__ == '__main__':
    ...
    empList.add_employee("123", "Ta", "Anh Tuan", "26/10/1998", "forder/taanhtuan", "Fresher")
    empList.add_employee("120", "Ta", "Van A", "20/10/1999", "forder/tavana", "Fresher")
    ...
    prodList.add_product(productID, productName, sup, cat, unit, price)
